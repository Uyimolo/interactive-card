...
class UI{
    ...
    static resetPage() {
       ...
       document.querySelectorAll(".input").forEach(input => input.classList.add("invalid"));
    ...
    static ValidateForm(input) {
               ...
               const empty = "Field can't be blank";
                    ...
                    if(input.value === "") {
                        ...
                        UI.showAlerts("Should have 16 characters", "form-group-2");
                        input.classList.add("invalid-input");
                        input.classList.add("invalid");
                    }
                    else{
                ...
                if(input.classList.contains("exp-month")) {
                    if(input.value === "") {
                        ...
                        UI.showAlerts("should contain 2 characters","form-group-3");
                        input.classList.add("invalid-input");
                        input.classList.add("invalid");
                    }
                    else{
                ...
                if(input.classList.contains("cvc")) {
                    if(input.value === "") {
                        ...
                        UI.showAlerts("Should contain 3 characters", "form-group-5");
                        input.classList.add("invalid-input");
                        input.classList.add("invalid");
                    }
                    else{
...
const inputsClass = inputsArr.map(input => input.classList.contains("invalid"));
